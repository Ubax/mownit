...
ggplot()+
  ...
  geom_point(data=points, aes(x, y), colour="blue",size=4)
    ...
    \begin{figure}[h]
        \center{\includegraphics[width=\textwidth]{lagrangePlot.png}}
...
double F(int a, int b, std::vector<Node> nodes) {
    ...
    \begin{figure}[h]
        \center{\includegraphics[width=\textwidth]{newton.png}}
    ...
    \begin{figure}[h]
        \center{\includegraphics[width=\textwidth]{all.png}}
...
analysis = data.frame(
    ...
    \subsection{Wykres}
    \begin{figure}[h]
        \center{\includegraphics[width=\textwidth]{spline.png}}
    ...
    \begin{figure}[h]
        \center{\includegraphics[width=\textwidth]{splineNewton.png}}
    ...
    \begin{figure}[h]
        \center{\includegraphics[width=\textwidth]{efekt.png}}
